"""
Django settings for artem_47962 project.
...
WSGI_APPLICATION = 'artem_47962.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "artem_47962 API",
    "DESCRIPTION": "API documentation for artem_47962 App",
    "VERSION": "v1",
}
